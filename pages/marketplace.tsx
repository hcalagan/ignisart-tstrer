  ...
  return (
    <div className="min-h-screen bg-ash">
      <main className="max-w-5xl mx-auto px-4 py-6">
        <h1 className="text-2xl font-bold text-flame dark:text-orange-400">{translate("marketplace", locale || "en")}</h1>
        {nfts.length === 0 ? (
          <p className="text-sm text-gray-600 dark:text-gray-400">{translate("no listings", locale || "en")}</p>
        ) : (
